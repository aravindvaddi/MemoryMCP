...
async def observe_with_context_internal(
    ...
    explicit_context: dict[str, Any] | None = Field(
        None, description="Explicitly provided context (e.g., current task, project info)"
    ),
    capture_system: bool = Field(True, description="Whether to automatically capture system context"),
    related_files: list[str] | None = Field(None, description="List of files related to this memory"),
) -> dict[str, Any]:
    """
